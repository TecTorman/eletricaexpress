...
public class clicadastro extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					comboBox.addItem("");
					clicadastro frame = new clicadastro();
	 ...
	 */
	public clicadastro() throws ParseException {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(clicadastro.class.getResource("/img/electric-power-plug-icon-31.png")));
		seleciona_cliente();
		...
		btnAtualizar.setIcon(new ImageIcon(clicadastro.class.getResource("/img/update.png")));
		...
		label.setIcon(new ImageIcon(clicadastro.class.getResource("/img/perosn.png")));
		...
		btnGravar.setIcon(new ImageIcon(clicadastro.class.getResource("/img/add.png")));
		...
		btnNovo.setIcon(new ImageIcon(clicadastro.class.getResource("/img/refesh.png")));
		...
		btnExcluir.setIcon(new ImageIcon(clicadastro.class.getResource("/img/trash.png")));
